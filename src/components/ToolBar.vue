    ...
    <div id="file-bar">
        <div class="dropdown">
            ...
            <div class="dropdown-content">
                ...
                <button for="myfile" id="open-file" @click="OpenFile"><img src="..\assets\pics\open-folder-svgrepo-com.svg" style="vertical-align:middle"> 
